...
// Threat Model (adversary classes, what is in/out of scope)
include::threat_model.adoc[]

// Updater Key Ceremony (operational runbook for the P2P updater signing key)
include::updater_key_ceremony.adoc[]
